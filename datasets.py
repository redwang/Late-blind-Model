...
if __name__ == '__main__':
    dataset = EMNIST(root='/mount/wd/data/emnist', split='mnist', train=True, download=True, transform=transforms.Compose([transforms.Scale(64),
                        transforms.ToTensor(),
                        transforms.Normalize(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
                ]))
    x,y = dataset.debug_getitem__()