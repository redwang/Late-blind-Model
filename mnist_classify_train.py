...
from networks import ClassifyNet
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        if epoch > 30:
            optimizer = optim.SGD(model.parameters(), lr=args.lr*0.1, momentum=args.momentum)
        ...
        if best_prec < prec:
            ...
            save_state = {'shared_layers': model.state_dict(),
                          'best_prec': best_prec}
            torch.save(save_state, './save_models/classify_mnist_best.pth')
